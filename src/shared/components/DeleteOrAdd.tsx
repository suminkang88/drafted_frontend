...
const DeleteOrAdd: React.FC<IconActionsProps> = ({
  ...
  return (
    <div className={`h-[30px] justify-start items-center gap-[15px] inline-flex ${className}`}>
      ...
      <button
        onClick={onAddClick}
        className="w-[30px] h-[30px] p-[6.25px] justify-center items-center flex overflow-hidden hover:opacity-80 transition-opacity focus:outline-none rounded group"
        aria-label="Add item"
      >
      ...
      <button
        ...
        className="w-[30px] h-[30px] px-[5px] py-[3.75px] justify-center items-center flex overflow-hidden hover:opacity-80 transition-opacity focus:outline-none rounded group"
